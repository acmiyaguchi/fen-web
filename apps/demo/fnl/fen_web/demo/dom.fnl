...
(fn host-apply [ops]
  (let [h _G.__fen_host]
    (if (and h h.dom_apply)
        (h.dom_apply ops)
        (error "fen_web.demo.dom: __fen_host.dom_apply is not installed"))))
...
;; @doc fen_web.demo.dom.reconcile-children!
;; kind: function
...
;; @doc fen_web.demo.dom.ensure-skeleton!
;; kind: function
...
;; @doc fen_web.demo.dom.render-frame!
;; kind: function
...
;; @doc fen_web.demo.dom.pump-input!
;; kind: function
