...
;; loader (fen_web.demo.boot.load-extension!) so owner cleanup and reload apply
...
{:name :fen_web_demo_preview
 :description "Demo-only preview.* tools driving the sandboxed iframe over host.preview (fen-web#8)."
 :entry-module :fen_web.demo.preview
 :reload-modules [:fen_web.demo.preview.html
                  :fen_web.demo.preview]}
