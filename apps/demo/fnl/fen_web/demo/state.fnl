...
;; @doc fen_web.demo.state.presenter-ctx
;; kind: data
;; signature: table|nil
...
;; @doc fen_web.demo.state.root-id
;; kind: data
;; signature: string
...
;; @doc fen_web.demo.state.status-info
;; kind: data
;; signature: table
