...
;; apps/web/src/bootTurn.test.ts. What THIS Fennel spec owns is the app-facing
...
;;
;; The starter files are real, reviewable source under apps/web/starter/. This
