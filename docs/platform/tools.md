...
| `preview_query`, `preview_click`, `preview_fill`, `preview_eval`, `preview_screenshot` | search | Specialized preview tools activated through `tool_search`; they remain available for focused queries, evaluation, and canvas capture. |
